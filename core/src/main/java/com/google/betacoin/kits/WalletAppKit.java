...
package com.google.betacoin.kits;
...
import com.google.betacoin.store.SPVBlockStore;
 ...
 * It is to make it easier to fit betacoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing betacoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the betacoinj website for further details.
     */
