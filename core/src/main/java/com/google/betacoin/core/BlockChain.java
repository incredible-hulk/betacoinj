...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link com.google.betacoin.store.SPVBlockStore} or you could also try a
     * {@link com.google.betacoin.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
