...
public abstract class Message implements Serializable {
    ...
    /**
     * Serialize this message to a byte array that conforms to the betacoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the betacoin wire format.
     *
     * @param stream
     * @throws IOException
     */
