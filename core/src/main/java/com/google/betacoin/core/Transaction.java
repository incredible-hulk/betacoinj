...
import static com.google.betacoin.core.Utils.NEGATIVE_ONE;
import static com.google.betacoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.betacoin.core.Utils.doubleDigest;
import static com.google.betacoin.core.Utils.reverseBytes;
import static com.google.betacoin.core.Utils.uint32ToByteStreamLE;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    // These are serialized in both betacoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.betacoin.script.Script, ECKey, com.google.betacoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.betacoin.core.Transaction.SigHash, boolean)}
