 ...
 *
 * <p>TransactionConfidence is updated via the {@link com.google.betacoin.core.TransactionConfidence#notifyWorkDone(Block)}
 * method to ensure the block depth and work done are up to date.</p>
 * To make a copy that won't be changed, use {@link com.google.betacoin.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence implements Serializable {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link com.google.betacoin.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        public enum ChangeReason {
            /**
             * Occurs when the type returned by {@link com.google.betacoin.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link com.google.betacoin.wallet.CoinSelector} implementations to risk analyze
