...
import org.betacoin.NativeSecp256k1;
...
public class ECKey implements Serializable {
     ...
     * usually encoded using DER format, so you want {@link com.google.betacoin.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link com.google.betacoin.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * the {@link com.google.betacoin.core.DumpedPrivateKey#toString()} method to get the string.
     *
