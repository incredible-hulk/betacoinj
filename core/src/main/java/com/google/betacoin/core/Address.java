...
public class Address extends VersionedChecksummedBytes {
    ...
    public NetworkParameters getParameters() {
        ...
        //NetworkParameters[] networks = { TestNet3Params.get(), MainNetParams.get(), UnitTestParams.get() }; //HULK: TESTNET REMOVAL
        NetworkParameters[] networks = { MainNetParams.get(), UnitTestParams.get() };
