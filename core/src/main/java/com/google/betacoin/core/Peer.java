...
import com.google.betacoin.store.BlockStore;
 ...
 * {@link com.google.betacoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.betacoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.google.betacoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.betacoin.net.StreamParser)}
     * or
     * {@link com.google.betacoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.betacoin.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // betacoinj is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link com.google.betacoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.betacoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.betacoin.core.Peer#ping()} has never
