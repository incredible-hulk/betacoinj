...
import com.google.betacoin.net.ClientConnectionManager;
import com.google.betacoin.net.NioClientManager;
import com.google.betacoin.net.discovery.PeerDiscovery;
import com.google.betacoin.net.discovery.PeerDiscoveryException;
import com.google.betacoin.script.Script;
import com.google.betacoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.betacoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.betacoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.betacoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.betacoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.betacoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.betacoin.core.Peer#ping()}.
     */
