 ...
 * the lightweight SPV mode, a {@link com.google.betacoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.betacoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
 ...
 *
 * <p>Every so often the block chain passes a difficulty transition point.</p>
 */
public abstract class AbstractBlockChain {
    ...
    private void checkDifficultyTransitions(StoredBlock storedPrev, Block nextBlock) throws BlockStoreException, VerificationException {
        ...
        final int averagingInterval2 = params.getAveragingInterval2();
    ...
    /**
     * Returns an estimate of when the given block will be reached, assuming a perfect 4 min average for each
    ...
    public Date estimateBlockTime(int height) {
        synchronized (chainHeadLock) {
            ...
            long estimated = (headTime * 1000) + (1000L * 60L * 4L * offset);
