...
package com.google.betacoin.utils;
 ...
 * betacoinj performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * betacoinj internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * betacoinj library code is run, setting it after you started network traffic and other forms of processing
    ...
    static {
        ...
        // instantiating any betacoinj objects. The policy change will take effect only on new objects
