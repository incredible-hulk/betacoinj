...
package com.google.betacoin.protocols.channels;

import com.google.betacoin.core.InsufficientMoneyException;
import com.google.common.util.concurrent.ListenableFuture;
import org.betacoin.paymentchannel.Protos;
...
public interface IPaymentChannelClient {
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.google.betacoin.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.google.betacoin.protocols.channels.PaymentChannelCloseException.CloseReason)}
    ...
    interface ClientConnection {
         ...
         * {@link com.google.betacoin.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link com.google.betacoin.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link com.google.betacoin.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link com.google.betacoin.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link com.google.betacoin.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * {@link com.google.betacoin.protocols.channels.PaymentChannelClient#incrementPayment(java.math.BigInteger)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link com.google.betacoin.protocols.channels.PaymentChannelClient}
