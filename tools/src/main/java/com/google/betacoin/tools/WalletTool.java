...
package com.google.betacoin.tools;

import com.google.betacoin.core.*;
import com.google.betacoin.crypto.KeyCrypterException;
import com.google.betacoin.net.discovery.DnsDiscovery;
...
import com.google.betacoin.protocols.payments.PaymentRequestException;
import com.google.betacoin.protocols.payments.PaymentSession;
import com.google.betacoin.store.*;
import com.google.betacoin.uri.BitcoinURI;
import com.google.betacoin.uri.BitcoinURIParseException;
import com.google.betacoin.utils.BriefLogFormatter;
...
public class WalletTool {
    ...
    private static org.betacoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("betacoin")) {
            ...
            try {
                paymentRequest = org.betacoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
