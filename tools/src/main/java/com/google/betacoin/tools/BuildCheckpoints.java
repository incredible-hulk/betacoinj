...
import com.google.betacoin.store.MemoryBlockStore;
...
public class BuildCheckpoints {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Configure betacoinj to fetch only headers, not save them to disk, connect to a local fully synced/validated
        ...
        StoredBlock test = manager.getCheckpointBefore(1396023831);  // Just after block 70,525
        checkState(test.getHeight() == 70525);
        checkState(test.getHeader().getHashAsString().equals("00000000000022abea2d6315e0114570a18240aa5ddd2eee4c8d580ec62aaf47"));
    }
}
